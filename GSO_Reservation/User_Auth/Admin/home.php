...
<section class="main">
          ...
          <table class="table">
            ...
            <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$row['sel_id'];?></td>
                    <td>
                            <button onClick="go()"><i class="fas fa-eye"></i></button>
                            <button onClick="del()"><i class="fas fa-trash"></i></button>
                    </td>
                  </tr>
                    <?php
                    }
    ...
    <script>
    function go() {
      location.replace("addAccount.php?id=<?=$row['id'];?>")
    }
    function del() {
      location.replace("DELETE.php?id=<?=$row['id'];?>")
    }
    function send() {
      location.replace("addAccount.php?id=<?=$row['id'];?>")
    }
